...
class MapCoordinates(Coordinates):
    zm: float = Field(12, ge=0, le=20, description="Zoom level (0-20)")
    width: float = Field(800, ge=0, description="Image width in pixels")
    height: float = Field(600, ge=0, description="Image height in pixels")
